...
TEST(TestFDDPS, FDDPS){
  ...
  Device device_1(DeviceStatus::Idle, DeviceType::NVGpu, "/GPU:0", 20, 20, 0);
  Device device_2(DeviceStatus::Idle, DeviceType::NVGpu, "/GPU:1", 20, 20, 0);
  Device device_3(DeviceStatus::Idle, DeviceType::NVGpu, "/GPU:2", 20, 20, 0);
  Device device_4(DeviceStatus::Idle, DeviceType::NVGpu, "/GPU:3", 20, 20, 0);
